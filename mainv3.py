...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_Load_2.clicked.connect(self.btn_purchase_clicked)
    ...
    def btn_lessthan_clicked(self):
        ...
        dup=False
        rowCtr=0
        while rowCtr!=self.tableWidget_3.rowCount():
            if self.tableWidget_3.item(rowCtr,0).text()==self.tableWidget_2.item(self.selectedRow,0).text():
                dup=True
                quantity=int(self.tableWidget_3.item(rowCtr,1).text())
                self.tableWidget_3.setItem(rowCtr , 1, QtGui.QTableWidgetItem(str(quantity+1)))
                self.itemPrice=float(col3.text())
                newPrice=self.itemPrice*(quantity+1)
                self.tableWidget_3.setItem(rowCtr , 2, QtGui.QTableWidgetItem(str(newPrice)))
        ...
        if dup==False:
            ...
            self.tableWidget_3.setItem(self.rowPosition , 1, QtGui.QTableWidgetItem("1"))
    ...
    def btn_greaterthan_clicked(self):
        ...
        if int(self.tableWidget_3.item(self.tableWidget_3.currentRow(),1).text())>1:
            quantity=int(self.tableWidget_3.item(self.tableWidget_3.currentRow(),1).text())-1
            self.tableWidget_3.setItem(self.tableWidget_3.currentRow() , 1, QtGui.QTableWidgetItem(str(quantity)))
            
            
            newPrice=(float(self.tableWidget_3.item(self.tableWidget_3.currentRow(),2).text()))/(quantity+1)
            newPrice=newPrice*quantity
            self.tableWidget_3.setItem(self.tableWidget_3.currentRow() , 2, QtGui.QTableWidgetItem(str(newPrice)))
        else:    
    ...
    def btn_reset_clicked(self):
        ...
        self.label_3.setText("Total amount in cart:0.0")
    def btn_purchase_clicked(self):
        msg = QtGui.QMessageBox()
        msg.setIcon(QtGui.QMessageBox.Information)

        msg.setText("Are you done purchasing?")
        #msg.setInformativeText("This is additional information") #additional info is needed
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Total amount in cart:0.0", None))
        ...
        self.actionChange_User.setText(_translate("MainWindow", "Account info", None))
